<div class="px-4 border border-gray-300 rounded-lg py-2 text-center flex justify-center items-center">
    {{-- The Master doesn't talk, he acts. --}}
    <x-button.secondary wire:click="$toggle('showModal')" class="flex items-center space-x-4"><i class="fas fa-upload text-gray-400 mr-2 ml-1"></i><span>Import</span></x-button.secondary>
                ...
                @unless ($upload)
                    <div class="py-12 flex flex-col items-center justify-center ">
                        <div class="flex items-center space-x-2 text-xl">
                            <i class="fas fa-upload text-gray-400 h-8 w-8"></i>
