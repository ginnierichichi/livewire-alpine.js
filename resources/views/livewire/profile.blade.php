            ...
            <form wire:submit.prevent="save">
                <div class="mt-6 sm:mt-5 space-y-5">
                    ...
                    <x-input.group label="Birthday" for="birthday" :error="$errors->first('birthday')">
                        <x-input.date wire:model.lazy="birthday" id="birthday" placeholder="DD/MM/YYYY" />
                    </x-input.group>
...
{{--                                @if ($newAvatar)--}}
{{--                                    <img class="h-20 overflow-hidden rounded-full" src="{{ $newAvatar->temporaryUrl() }}" alt="Profile Photo" >--}}
{{--                                @else--}}
{{--                                    <img class="h-20 overflow-hidden rounded-full" src="{{ auth()->user()->avatarUrl() }}" alt="Profile Photo" >--}}
{{--                                @endif--}}
{{--                            </span>--}}
{{--                        </x-input.file-upload>--}}
                    </x-input.group>
